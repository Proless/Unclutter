namespace Unclutter.Services.Data
{
    public class SqliteScripts
    {
        public class Table
        {
            public class Game
            {
                public const string Create = "CREATE TABLE IF NOT EXISTS Game (Id INTEGER NOT NULL, Name TEXT, ForumUrl TEXT, NexusModsUrl TEXT, Genre TEXT, FileCount INTEGER, Downloads INTEGER, DomainName TEXT, ApprovedDate INTEGER, FileViews INTEGER, Authors INTEGER, FileEndorsements INTEGER, Mods INTEGER, PRIMARY KEY(Id))";
            ...
            public class User
            {
                public const string Create = "CREATE TABLE IF NOT EXISTS User (Id INTEGER NOT NULL, Key TEXT, Name TEXT, Email TEXT, ProfileUri TEXT, IsSupporter INTEGER, IsPremium INTEGER, PRIMARY KEY(Id))";
            ...
            {
                public const string Create = "CREATE TABLE IF NOT EXISTS Profile (Id INTEGER NOT NULL, GameId INTEGER NOT NULL, UserId INTEGER NOT NULL, Name TEXT, DownloadsDirectory TEXT, FOREIGN KEY(GameId) REFERENCES Game(Id), FOREIGN KEY(UserId) REFERENCES User(Id), PRIMARY KEY(Id AUTOINCREMENT))";
