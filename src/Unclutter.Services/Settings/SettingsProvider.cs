...
namespace Unclutter.Services.Settings
{
    public class SettingsProvider : ISettingsProvider
    {
        ...
        /* Constructor */
        public SettingsProvider(IContainerExtension containerExtension, IJsonService jsonService, IDirectoryService directoryService, IProfilesManager profilesManager)
        {
        ...
        /* Methods */
        public ISettings<T> RegisterSettings<T>(string name, Action<T> defaults) where T : class, new()
        {
            InternalRegisterSettings(name, defaults, false);
            return GetSettings<T>(name);
        }

        public ISettings<T> RegisterProfileSettings<T>(string name, Action<T> defaults) where T : class, new()
        {
