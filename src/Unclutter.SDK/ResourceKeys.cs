namespace Unclutter.SDK
{
    public class ResourceKeys
    {
        ...
        public const string API_Key_Msg_Validating_Success = nameof(API_Key_Msg_Validating_Success);
        public const string API_Key_TextBox_Hint = nameof(API_Key_TextBox_Hint);
        public const string DFolder_Msg_Invalid = nameof(DFolder_Msg_Invalid);
        public const string DFolder_Msg_Required = nameof(DFolder_Msg_Required);
        public const string DFolder_Msg_Select = nameof(DFolder_Msg_Select);
        public const string DFolder_Location = nameof(DFolder_Location);
        ...
        public const string Loading_Status = nameof(Loading_Status);
        public const string Profile_Msg_Delete_Confirm = nameof(Profile_Msg_Delete_Confirm);
        public const string Profile_New = nameof(Profile_New);
        public const string Profile_Switch = nameof(Profile_Switch);
        public const string Profile_New_Hint = nameof(Profile_New_Hint);
        public const string Profile_Msg_Delete_Error = nameof(Profile_Msg_Delete_Error);
        public const string Profile_Name_Msg_Invalid = nameof(Profile_Name_Msg_Invalid);
        public const string Profile_Name_Msg_Required = nameof(Profile_Name_Msg_Required);
        public const string Server_Connection_Error = nameof(Server_Connection_Error);
        public const string Profile_Get_Started = nameof(Profile_Get_Started);
        public const string Profile_Hint = nameof(Profile_Hint);
        public const string Profile_Name = nameof(Profile_Name);
        public const string Game_Select_Hint = nameof(Game_Select_Hint);
        public const string Profile_Name_Hint = nameof(Profile_Name_Hint);
